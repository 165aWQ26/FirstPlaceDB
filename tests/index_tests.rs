...
mod tests {
    ...
    fn delete_lots() {
        ...
        assert_eq!(
            my_index.locate_range(5, 8),
            Some(vec![4, 5, 6, 7, 8, 9, 10, 11, 12])
        );
    }
    #[test]
    fn delete_locate_range() {
        let mut my_index = Index::new();
        my_index.insert(5, 1);
        my_index.insert(5, 2);
        my_index.insert(6, 3);
        ...
        my_index.remove(5, 8);
        my_index.remove(6, 9);
        my_index.remove(7, 10);
        my_index.remove(8, 11);
        my_index.remove(8, 12);
        assert_eq!(my_index.locate(5), None);
        assert_eq!(my_index.locate_range(5, 8), None);
    }
}
