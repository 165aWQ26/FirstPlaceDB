...
class Query:
    ...
    def __init__(self, table):
        self.table = table
        self._core = CoreQuery(table._core_db, table.name)
    ...
    def insert(self, *columns):
        return self._core.insert(list(columns))
    ...
    def select_version(
        ...
        rows = self._core.select_version(
            search_key, search_key_index, projected_columns_index, relative_version
        )
        return [Record(0, search_key, row) for row in rows]
    ...
    def update(self, primary_key, *columns):
        return self._core.update(primary_key, list(columns))
